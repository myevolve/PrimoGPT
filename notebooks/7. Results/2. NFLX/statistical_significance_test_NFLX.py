...
def main():
    ...
    strategy_files = [
        ('nflx_primorl_df_account_value_ppo.pkl', 'PrimoRL', 'account_value'),
        ('nflx_finrl_df_account_value_ppo.pkl', 'FinRL', 'account_value'),
        ('nflx_finrl_buy_and_hold.pkl', 'Buy and Hold', 'close'),
        ('nflx_macd_strategy.pkl', 'MACD', 'Value'),
        ('nflx_momentum_strategy.pkl', 'Momentum', 'Value'),
        ('nflx_p_ma_strategy.pkl', 'Price MA', 'Value')
    ]
